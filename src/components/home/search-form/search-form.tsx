  ...
  return (
    ...
    >
      <div className="mb-3 sm:mb-0">
        <span className="mb-2 hidden font-primary text-xl leading-8 text-red sm:block 4xl:text-[28px] 4xl:leading-[44px]">
          Emergency Bookings
        </span>
        <Text
          tag="h1"
          className="leading-12 mb-8 !text-xl !font-black text-red sm:!text-[28px] sm:!leading-9  4xl:!text-4xl 4xl:!leading-[52px]"
        >
          Call 8102030413
        </Text>
        <Text className="mb-2 hidden leading-6 font-black !text-secondary sm:block 3xl:leading-8 4xl:mb-6 4xl:text-lg">
          For future bookings:
        </Text>
      </div>
      <SearchAutocomplete
